...
export const metadata: Metadata = {
  title: "A.Modwi | Sales & Customer Experience Professional",
  description: "Ahmed Modwi Ibrahim - Sales & Customer Experience Professional based in Dubai, UAE. Specialized in customer engagement, digital marketing, and consultative service.",
  icons: {
